    ...
    <div :class="['header', { 'js-c_010D-meganav-open': meganavActive }, { 'js-c_010D-menu-open': sidebarActive }]">
        ...
        <div itemscope="itemscope" itemtype="http://schema.org/WPHeader">
            <div class="noindex">
                ...
                <header class="c_010D c_010D-theme-dark c_010D-logo-small" role="navigation" data-initiated="true"
                    style="margin-bottom: 50.6667px;" data-height-set-by-c_046c="">
                    <div class="c_010D-breakpoint-test"></div>
                    <div class="c_010D-overlay"></div>

                    <div class="wrapper">

                        <a v-if="basicInformation" :href="basicInformation.site_url" class="logo-container"
                            role="logo" aria-label="logo">
                            <picture class="logo svg js-c_010D-svg-inline">
                                <source
                                    srcset="//libs-europe.nissan-cdn.net/etc/designs/nissan_next_v4/24.08.32.NISSAN-6/common-assets/img/svg/nissan-next-logo.svg"
                                    media="screen and (min-width: 960px)">
                                <source
                                    srcset="//libs-europe.nissan-cdn.net/etc/designs/nissan_next_v4/24.08.32.NISSAN-6/common-assets/img/svg/nissan-next-logo.svg"
                                    media="print">
                                <img src="//libs-europe.nissan-cdn.net/etc/designs/nissan_next_v4/24.08.32.NISSAN-6/common-assets/img/svg/nissan-next-logo-text.svg"
                                    alt=""><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 504 421.7" style="enable-background:new 0 0 504 421.7;"
                                    xml:space="preserve" class="desktop">
                            ...
                            <div class="sidebar-mobile-inner">
                                <div class="menu">
                                    ...
                                    <ul class="primary">
                                        ...
                                        <li :class="[{ 'has-meganav': mainIndex === 0 }, { 'has-menu': mainIndex !== 0 }, { 'js-c_010D-dropdown-off-screen': mainIndex === 3 }, { 'js-c_010D-accordion-open': mainIndex === mobileNonVehicleActive }, { 'focus-active': mainIndex === mobileNonVehicleActive }]"
                                            @mouseover="hoveredIndex = mainIndex" @mouseleave="hoveredIndex = null"
                                            v-for="(main, mainIndex) in mainNavigation" :key="mainIndex"
                                            @click="toggleVehicle(mainIndex); mobileNonVehicleDropdown(mainIndex);">
                                            <a :class="[{ 'primary-nav-opened': mainIndex === mobileNonVehicleActive || hoveredIndex === mainIndex }]"
                                                v-if="main.active === 1">{{ main.title }}</a>

                                            <ul v-if="mainIndex !== 0 && main.active === 1" class="dropdown">

                                                <li v-for="(dropdown, dropdownIndex) in main.children"
                                                    :key="dropdownIndex">
                                                    <a :href="dropdown.url" v-if="dropdown.active === 1">{{
                                                        dropdown.title }}</a>
                                                    <a :href="dropdown.url"
                                                        v-if="dropdown.active === 1 && dropdown.meta.image">
                                ...
                                <aside class="sidebar-desktop" role="sidebar" aria-label="sidebar navigation"
                                    ...
                                    <div class="sidebar-desktop-inner">
                                        ...
                                        <ul class="sidebar" style="margin-bottom: 40px;">
                                            ...
                                            <li v-for="(sidebar, sidebarIndex) in sideNavigation"
                                                :key="sidebarIndex"
                                                :class="[{ 'margin-bottom-sidebar': sidebar.meta.marginBottom }]"><a
                                                    :href="sidebar.url" :target="sidebar.target"
                                                    v-if="sidebar.active === 1">{{ sidebar.title }}</a></li>
                    ...
                    <div class="meganav-container">
                        <div class="c_010D-meganav">
                            ...
                            <ul class="categories"
                                v-if="mainNavigation && mainNavigation[0] && mainNavigation[0].children">

                                <li v-for="(vehicleType, vehicleTypeIndex) in mainNavigation[0].children"
                                    :key="vehicleTypeIndex" @click="toggleVehicleType(vehicleTypeIndex)"><a
                                        :class="[{ 'active': vehicleTypeIndex === vehicleTypeActive }]"
                                        :href="vehicleType.url" v-if="vehicleType.active === 1">{{ vehicleType.title
                                        }}</a></li>

                            </ul>

                            <div class="categories-wrapper"
                                v-if="mainNavigation && mainNavigation[0] && mainNavigation[0].children && mainNavigation[0].children[0].children">

                                <div v-for="(subNavigation, index) in mainNavigation[0].children"
                                    :class="['vehicles-container', { 'active': vehicleTypeActive === index }]"
                                    :data-tabname="'category-' + index" :key="index">

                                    <div class="vehicle-block-wrapper">

                                        <a v-for="(vehicleAll, vehicleAllIndex) in (subNavigation.children || []).filter(vehicle => Number(vehicle.active) === 1)"
                                            :key="vehicleAllIndex" class="vehicle-block" :href="vehicleAll.url"
                                            :target="vehicleAll.target">
                                    ...
                                    <div class="more-vehicles">
                                        <a v-if="subNavigation.meta.more" class="chevron-right"
                                            :href="basicInformation.meta[subNavigation.meta.more + '_url']">
        ...
        <div class="title liveChatScript" v-if="livechatUrl">
            ...
            <div class="c_095A c_095A-modernised"
                ...
                data-live-chat-init-param1="572b0000000TYXI" data-live-chat-init-param2="00Db0000000cZvn"
                data-live-chat-button-id="573b0000000TYYY" data-live-chat-tooltip="Live chat"
                data-live-chat-custom-detail="{&quot;Brand&quot;:&quot;Nissan&quot;,&quot;caseSubType&quot;:&quot;Nissan Site&quot;}">
